...
class LibXmlTest extends TestCase
{
    ...
    public function testValidateOnXsdVersion1Dot1(): void
    {
        ...
        try {
            $xsd = \Rebelo\SaftPt\Validate\Schema\Schema::ORIGINAL_AT_XSD;
    ...
    {
        try {
            $xsd = \Rebelo\SaftPt\Validate\Schema\Schema::XSD_V_1_0;
    ...
    {
        $xsd = \Rebelo\SaftPt\Validate\Schema\Schema::GLOBAL_XSD;
    ...
    {
        $xsd = \Rebelo\SaftPt\Validate\Schema\Schema::PERMISSIVE_XSD;
